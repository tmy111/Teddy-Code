...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("skills", "/skills", "List available TeddyCode skills.", ("sk",)),
    SlashCommand("skill", "/skill <name> [args]", "Load and run a TeddyCode skill."),
    ...
    SlashCommand("exit", "/exit", "Exit TeddyCode.", ("quit",)),
)
