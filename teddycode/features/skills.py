...
SKILL_FILE_CREATION_GUIDE = """When creating TeddyCode skill files at .teddycode/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${TEDDYCODE_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    user_home = _safe_home(home)
    search_roots = [
        (Path(root) / "skills", "project"),
        (Path(root) / ".teddycode" / "skills", "project"),
    ]
    if user_home is not None:
        search_roots.insert(0, (user_home / ".teddycode" / "skills", "user"))
